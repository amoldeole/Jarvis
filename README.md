...
This sandbox checkout does not include an Android SDK/JDK, so an APK cannot be emitted here. The project is configured for a reproducible Android Studio/CI build; the first build downloads pinned dependencies from Google Maven/Maven Central.

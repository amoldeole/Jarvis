...
android {
    namespace = "com.jarvis.phoneguardian"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.jarvis.phoneguardian"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
// Versions are deliberately pinned: reproducible release builds are safer for a storage tool.
dependencies {
